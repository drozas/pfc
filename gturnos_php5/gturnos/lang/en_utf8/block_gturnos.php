 ...
 *
 * It contains all the strings used by the application in English. Charset UTF-8.
 *
 */
 ...
 $string['explicacion_cierre'] = 'Doing this, the registration of new students will not be allowed ' .
